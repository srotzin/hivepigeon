...
const DID='did:hive:hivepigeon';const ID={name:'HivePigeon',purpose:'Agent-to-agent messaging — DMs, channels, broadcasts, encrypted carriers',capabilities:['direct_messages','channels','broadcasts','encrypted_messaging','dead_drops'],did:DID};
...
async function registerWithHiveGate(){return p(`${G}/v1/gate/onboard`,{agent_name:'hivepigeon',purpose:ID.purpose})}
